...
public class ManagerTest {
    ...
    public void testCreateFestival() throws Exception{
        manager.createFestival(1, "Festival Test", "City Test", "Location Test", LocalDate.now(), null, Province.AGRIGENTO, 100, 1, new int[]{100}, new double[]{50.0}, Genre.ROCK, manager, "", "Description Test", 1);
        assertEquals(1, manager.getEvent().size());
    }

    @Test
    public void testDontCreateFestival() throws Exception{
        Exception exception = assertThrows(Exception.class, () -> {
            // In questo test non dovrebbe creare l'evento perché il manager 1 ha l'abbonamento scaduto
            manager1.createFestival(2, "Festival Test", "City Test", "Location Test", LocalDate.now(), null, Province.AGRIGENTO, 100, 1, new int[]{100}, new double[]{50.0}, Genre.ROCK, manager1, "", "Description Test", 1);
        });
    ...
    public void testCreateConcert() throws Exception{
        manager.createConcert(1, "Concert Test", "City Test", "Location Test", LocalDate.now(), null, Province.AGRIGENTO, 200, 1, new int[]{200}, new double[]{100.0}, Genre.POP, manager, "", "Description Test");
        assertEquals(1, manager.getEvent().size());
    }
    ...
    */
    ...
    public void testCreateOther() throws Exception {
        manager.createOther(4, "Other Test", "City Test", "Location Test", LocalDate.now(), null, Province.AGRIGENTO, 400, 1, new int[]{400}, new double[]{200.0}, Genre.ROCK , manager, "", "Description Test");
        assertEquals(1, manager.getEvent().size());
    }
